...
@section('content')
  <div class="page page-center">
    <div class="container container-tight py-4">
      ...
      <form class="card card-md" action="{{route('change_password')}}" method="post" autocomplete="off">
          @csrf
          <div class="card-body">
            ...
            <p class="text-secondary mb-4">Sila masukkan <i>username</i> akaun anda dan kami akan menghantar pautan untuk menetap semula kata laluan anda.</p>
            <div class="mb-3">
